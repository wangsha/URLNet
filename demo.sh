...
for ((i=0; i <${#emb_modes[@]}; ++i))
    ...
    --data.word_dict_dir runs/${train_size}_emb${emb_modes[$i]}_dlm${delimit_modes[$i]}_32dim_minwf1_1conv3456_${nb_epoch}ep_expert${add_expert_feature}/words_dict.p \
    --data.subword_dict_dir runs/${train_size}_emb${emb_modes[$i]}_dlm${delimit_modes[$i]}_32dim_minwf1_1conv3456_${nb_epoch}ep_expert${add_expert_feature}/subwords_dict.p \
    --data.char_dict_dir runs/${train_size}_emb${emb_modes[$i]}_dlm${delimit_modes[$i]}_32dim_minwf1_1conv3456_${nb_epoch}ep_expert${add_expert_feature}/chars_dict.p \
